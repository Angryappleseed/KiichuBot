...
class HelpView(discord.ui.View):
    ...
    def get_homescreen_embed(self):
        ...
        embed = discord.Embed(
            ...
            description = "It is HIGHLY recommended to enable developer mode when setting up this bot.",
            color=colors["blue"],   
        )
...
class General(commands.Cog, name="general"):
    def __init__(self, bot):
        ...
        self.cog_descriptions = {
            ...
            'moderation': "Commands for managing members.",
            'tasks': "Commands for background tasks.",
...
#-------------------- HELP------------------------#
    ...
    async def help(self, ctx):
        included_cogs = ["general", "moderation", "tasks", "owner"]
